...
class Ui_QtClock(object):
    def setupUi(self, QtClock):
        ...
        self.verticalLayout.addWidget(self.label_7, 0, Qt.AlignHCenter|Qt.AlignBottom)
    ...
    def retranslateUi(self, QtClock):
        ...
        self.windowontop.setText(QCoreApplication.translate("QtClock", u"\u542f\u7528\u7a97\u53e3\u7f6e\u9876", None))
        self.close.setText(QCoreApplication.translate("QtClock", u"\u5173\u95ed", None))
        self.label_7.setText(QCoreApplication.translate("QtClock", u"TextLabel", None))
    # retranslateUi
...
class Ui_QtClock(object):
    def setupUi(self, QtClock):
        ...
        self.soup = QLabel(self.centralwidget)
        self.soup.setObjectName(u"soup")

        self.verticalLayout.addWidget(self.soup, 0, Qt.AlignHCenter|Qt.AlignBottom)
    ...
    def retranslateUi(self, QtClock):
        ...
        self.windowontop.setText(QCoreApplication.translate("QtClock", u"\u542f\u7528\u7a97\u53e3\u7f6e\u9876", None))
        self.close.setText(QCoreApplication.translate("QtClock", u"\u5173\u95ed", None))
        self.soup.setText(QCoreApplication.translate("QtClock", u"TextLabel", None))
    # retranslateUi
...
class Ui_QtClock(object):
    def setupUi(self, QtClock):
        ...
        self.reset_soup = QPushButton(self.centralwidget)
        self.reset_soup.setObjectName(u"reset_soup")

        self.horizontalLayout_3.addWidget(self.reset_soup)
    ...
    def retranslateUi(self, QtClock):
        ...
        self.Freamleass.setText(QCoreApplication.translate("QtClock", u"\u6253\u5f00\u7a97\u53e3\u65e0\u8fb9\u6846", None))
        self.windowontop.setText(QCoreApplication.translate("QtClock", u"\u542f\u7528\u7a97\u53e3\u7f6e\u9876", None))
        self.reset_soup.setText(QCoreApplication.translate("QtClock", u"\u6362\u6c64", None))
        self.close.setText(QCoreApplication.translate("QtClock", u"\u5173\u95ed", None))
        self.soup.setText(QCoreApplication.translate("QtClock", u"TextLabel", None))
    # retranslateUi
